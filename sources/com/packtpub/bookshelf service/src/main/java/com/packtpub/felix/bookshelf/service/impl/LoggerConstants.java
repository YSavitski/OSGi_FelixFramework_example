...
public interface LoggerConstants {
    ...
    String LOG_CHECK_SESSION_SUCCESS = "LOG_CHECK_SESSION_SUCCESS: Session check succesed [session={0}]";

    String LOG_GET_BOOKS_COUNT = "LOG_GET_BOOKS_SIZE: Books count check succesed [session={0}]";
