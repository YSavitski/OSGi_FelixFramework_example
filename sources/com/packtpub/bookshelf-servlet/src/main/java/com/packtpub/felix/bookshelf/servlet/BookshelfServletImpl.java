...
@Component(name = "BookshelfServletImpl", immediate = true)
@Provides
public class BookshelfServletImpl extends HttpServlet {
    ...
    private void htmlCategories(PrintWriter printWriter) throws InvalidCredentialException {
        htmlTop(printWriter);
    ...
    private void doLogin(String user, String pass) throws InvalidCredentialException {
